...
Estado de referencia: `main@3342161d06028f08a3a5b2e49454126203d70f92`.
...
| Requirement | Expected Surface | Acceptance | Evidence in main | Recovery |
|---|---|---|---|---|
...
| OWNER: registro y login | UI + API + persistence + security | Una persona crea cuenta OWNER, inicia sesión y conserva una sesión segura | Login existente; registro/UI missing | R1 |
...
| Transversal: estados UI | UI | Pantallas reales exponen loading, empty, error y sesión expirada | Shell only | R1–R5 |
...
- El backend de registro OWNER todavía no existe.
- La evidencia actual demuestra capacidades de backend, no recorridos de producto.
